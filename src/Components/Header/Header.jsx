      ...
      <main >
        <div className="w-[100%] relative  items-center align-middle flex justify-center z-10   h-[650px] ">
          ...
          <div className="cards flex sm:flex-col z-20 transform absolute md:left-10 top-[40%] md:mt-[-10px] sm:left-0 shadow-md mt-[-65px] sm:mt-28 gap-3 ">
          {
            ...
            <div className="z-30">
            <img className="md:w-[100px] md:h-[100px]  w-[70px] h-[70px]  shadow-md rounded-md z-20 hover:scale-125 transition-all  duration-300 " src={card.image} alt="" />
          </div>
            )))
          }
          ...
          <div className="absolute  sm:mt-[120px] mt-[200px] flex justify-center items-center ">
            <img
